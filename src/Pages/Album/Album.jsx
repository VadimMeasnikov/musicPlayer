                ...
                <div className="album_container" >
                    ...
                    <div className="album_color__top" style={{ background: bg }}>
                        ...
                        <div className="album_search_content">
                            <form onChange={(e) => getDataInAlbum(e, dataResult)} className='search_in_plsylist__form'>
                                <div style={{ background: bgInp }} className="search_box">
                                    <label><IoSearch /></label>
                                    <input
                                    ...
                                    <div className="content__1__info">
                                        <div className="main_album__info">
                                            <div className="content_text">
                                                <p className='info_1'>{albumName} {artist && `by ${artist}`}</p>
                                                <p className='album__info'>Album • {albumRelease ? `${albumRelease} • ` : ""}{albumLength} tracks</p>
                                            </div>
                                        </div>
                                    </div>
